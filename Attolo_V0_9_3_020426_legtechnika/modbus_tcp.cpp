...
static void updateModbusOutputsFromStatus()
{
 ...
 modbusTCPServer.holdingRegisterWrite(HMI_HR_FAN1_FREQ_CMD_X10, clampHzX10(st.fan1_freq_cmd_hz));
 modbusTCPServer.holdingRegisterWrite(HMI_HR_FAN1_FREQ_ACT_X10, clampHzX10(st.fan1_freq_act_hz));
 modbusTCPServer.holdingRegisterWrite(HMI_HR_FAN2_FREQ_CMD_X10, clampHzX10(st.fan2_freq_cmd_hz));
 modbusTCPServer.holdingRegisterWrite(HMI_HR_FAN2_FREQ_ACT_X10, clampHzX10(st.fan2_freq_act_hz));

  modbusTCPServer.holdingRegisterWrite(HMI_HR_FAN1_DAMPER_CMD_PCT_X10, clampHzX10(st.fan1_damper_cmd_pct));
  modbusTCPServer.holdingRegisterWrite(HMI_HR_FAN1_DAMPER_FB_PCT_X10, clampHzX10(st.fan1_damper_fb_pct));
}
