...
static float humidityDemandPct(float rh)
{
  ...
  if (rh <= 60.0f) return 0.0f;
  if (rh <= 70.0f) return lerpClamped(rh, 60.0f, 70.0f, 0.0f, 30.0f);
  if (rh <= 80.0f) return lerpClamped(rh, 70.0f, 80.0f, 30.0f, 70.0f);
  if (rh <= 90.0f) return lerpClamped(rh, 80.0f, 90.0f, 70.0f, 100.0f);
  return 100.0f;
}
