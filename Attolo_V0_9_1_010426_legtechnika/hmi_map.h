...
constexpr uint16_t HMI_COIL_VENT_AUTO_ENABLE   = 12; // légtechnika ki/be kapcsolása
...
constexpr uint16_t HMI_ST_VENT_AUTO_ENABLE     = 133; // klímaventillátorok automata üzeme
...
constexpr uint16_t HMI_HR_TEST_CONST = 212;

constexpr uint16_t HMI_HR_FAN1_DAMPER_CMD_PCT_X10 = 220;
constexpr uint16_t HMI_HR_FAN1_DAMPER_FB_PCT_X10 = 221;
