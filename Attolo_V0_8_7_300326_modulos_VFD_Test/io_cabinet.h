...
constexpr int PIN_DI_PUSH_HOME       = CONTROLLINO_AI3;   // doboz
constexpr int PIN_DI_PUSH_EXT        = CONTROLLINO_AI4;   // doboz
...
constexpr int PIN_DI_JOG_BTN         = CONTROLLINO_AI10;
constexpr int PIN_AI_ENCODER         = CONTROLLINO_AI11;
constexpr int PIN_DI_RESET           = CONTROLLINO_DI0;

// Outputs
constexpr int PIN_DO_STOP_REQ        = CONTROLLINO_DO0;
constexpr int PIN_DO_GREEN_LIGHT     = CONTROLLINO_DO1;
