...
static const uint32_t STEP_INTERVAL_MS       = 200;
static const uint16_t SLAVE_SWITCH_DELAY_MS  = 10;
static const uint32_t COMM_OK_TIMEOUT_MS     = 2000;
...
static VFDDrive g_vfds[3] = {
  ...
  { 11, "Fan1",   0, 0, 0, 0, 0, false, 20.0f, false, -1.0f },
  { 12, "Fan2",   0, 0, 0, 0, 0, false, 20.0f, false, -1.0f }
};
...
static void processWriteStep() {
  if (g_writeDriveIndex < 0 || g_writeDriveIndex >= 3) {
