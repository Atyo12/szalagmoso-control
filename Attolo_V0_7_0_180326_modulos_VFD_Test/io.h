...
constexpr int PIN_DI_PUSH_HOME       = 3;
...
constexpr int PIN_DI_RESET           = 8;
constexpr int PIN_DI_SERVICE_KEY     = 9;
constexpr int PIN_DI_LOCAL_JOG       = 10;

// Outputs
constexpr int PIN_DO_STOP_REQ        = 0;
constexpr int PIN_DO_RET_CONV        = 1;
constexpr int PIN_DO_PUSH_MOTOR      = 2;
