...
static void updateModbusOutputsFromStatus()
{
  ...
  modbusTCPServer.coilWrite(HMI_ST_VENT_AUTO_ENABLE,  st.vent_auto_enable);
  ...
  modbusTCPServer.holdingRegisterWrite(HMI_HR_TEST_CONST,       1234); // test regiszter
...
static void applyModbusInputsToHmi()
{
  ...
  hmiSetVentAutoEnable(modbusTCPServer.coilRead(HMI_COIL_VENT_AUTO_ENABLE));
