...
static void superviseOutOpto()
{
  ...
  // ------------------------------------------------------------
  // 1) Wash stop AZONNAL:
  //    ha push ciklus fut, az OUT optó foglalt,
  //    és még nincs HOME-ban, akkor a mosó azonnal álljon meg.
  // ------------------------------------------------------------
  if (push_active &&
      di_out_opto.stable &&
      !di_push_home.stable) {
  ...
  // ------------------------------------------------------------
  // 2) E501 számláló CSAK később induljon:
  //    ha az OUT optó foglalt,
  //    az EXT már egyszer megvolt ebben a ciklusban,
