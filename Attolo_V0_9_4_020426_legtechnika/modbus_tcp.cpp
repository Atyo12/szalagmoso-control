...
static void updateModbusOutputsFromStatus() {
  ...
  modbusTCPServer.coilWrite(HMI_ST_FAN2_RUNNING,         st.fan2_running);   // ÚJ
...
static void applyModbusInputsToHmi() {
  ...
  hmiSetFan1DamperSetPct(modbusTCPServer.holdingRegisterRead(HMI_HR_FAN1_DAMPER_SET_PCT_X10) / 10.0f); // ÚJ
