...
static void supervisePushCycle() {
  ...
  // Hamis push ellen:
  // EXT önmagában még nem bizonyítja, hogy raklap érkezett a returnre,
  // ezért itt NEM indítjuk el a return szalagot.
  // A return majd csak valós jelre induljon (ret_start / ret_load / ret_end).
