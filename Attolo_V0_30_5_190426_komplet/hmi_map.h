...
constexpr uint16_t HMI_HR_PARAM_ACT_SEMAFOR_PULSES = 264;
...
constexpr uint16_t HMI_HR_PARAM_FREE_MIN_SEC           = 321;
constexpr uint16_t HMI_HR_PARAM_BLOCK_MAX_SEC          = 322;
...
constexpr uint16_t HMI_HR_PARAM_SEMAFOR_PULSES = 337;
...
constexpr uint16_t HMI_HR_PARAM_ACT_FREE_MIN_SEC           = 241;
constexpr uint16_t HMI_HR_PARAM_ACT_BLOCK_MAX_SEC          = 242;
...
// ------------------------------------------------------------
// LÉGTECHNIKA AUTO PARAMÉTEREK (HMI -> PLC)
// ------------------------------------------------------------
constexpr uint16_t HMI_HR_PARAM_CLIMATE_ON_DEMAND_PCT_X10      = 343;
constexpr uint16_t HMI_HR_PARAM_CLIMATE_OFF_DEMAND_PCT_X10     = 344;
constexpr uint16_t HMI_HR_PARAM_CLIMATE_MIN_RUN_SEC            = 345;

constexpr uint16_t HMI_HR_PARAM_FAN2_AUTO_MIN_HZ_X10           = 346;
constexpr uint16_t HMI_HR_PARAM_FAN2_AUTO_MAX_HZ_X10           = 347;
constexpr uint16_t HMI_HR_PARAM_FAN1_AUTO_MIN_HZ_X10           = 348;

constexpr uint16_t HMI_HR_PARAM_HOT_OFFSET_TEMP_C_X10          = 349;
constexpr uint16_t HMI_HR_PARAM_HOT_FORCE_TEMP_C_X10           = 350;
constexpr uint16_t HMI_HR_PARAM_HOT_FORCE_FAN2_MIN_HZ_X10      = 351;
constexpr uint16_t HMI_HR_PARAM_HOT_FORCE_FAN1_MIN_HZ_X10      = 352;


// ------------------------------------------------------------
// VISSZAJELZETT (ACTUAL) PARAMÉTEREK (PLC -> HMI)
// ------------------------------------------------------------
constexpr uint16_t HMI_HR_PARAM_ACT_CLIMATE_ON_DEMAND_PCT_X10  = 265;
constexpr uint16_t HMI_HR_PARAM_ACT_CLIMATE_OFF_DEMAND_PCT_X10 = 266;
constexpr uint16_t HMI_HR_PARAM_ACT_CLIMATE_MIN_RUN_SEC        = 267;

constexpr uint16_t HMI_HR_PARAM_ACT_FAN2_AUTO_MIN_HZ_X10       = 268;
constexpr uint16_t HMI_HR_PARAM_ACT_FAN2_AUTO_MAX_HZ_X10       = 269;
constexpr uint16_t HMI_HR_PARAM_ACT_FAN1_AUTO_MIN_HZ_X10       = 270;

constexpr uint16_t HMI_HR_PARAM_ACT_HOT_OFFSET_TEMP_C_X10      = 271;
constexpr uint16_t HMI_HR_PARAM_ACT_HOT_FORCE_TEMP_C_X10       = 272;
constexpr uint16_t HMI_HR_PARAM_ACT_HOT_FORCE_FAN2_MIN_HZ_X10  = 273;
constexpr uint16_t HMI_HR_PARAM_ACT_HOT_FORCE_FAN1_MIN_HZ_X10  = 274;
