...
static void updateCounters() {
  ...
  // Csak akkor fogadjuk el a ret_start jelet,
  // ha tényleg várunk raklapot egy push ciklusból.
  if (g_ret_feed_pending) {
    ...
    // ne csak később, a ciklus végén / HOME környékén.
...
static void superviseReturnGhostLoad() {
  ...
  bool return_expected_to_move =
      cmd_ret_conv || hmi_ret_conv_continuous;
